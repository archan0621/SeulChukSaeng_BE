...
#ENTRYPOINT ["java", "-jar", "-javaagent:/pinpoint-agent/pinpoint-bootstrap-2.5.3.jar", "-Dpinpoint.applicationName=SubBackEnd", "-Dpinpoint.agentId=besub", "-Dpinpoint.config=/pinpoint-agent/pinpoint-root.config", "/app.jar"]
